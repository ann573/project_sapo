...
interface ProductListProps {
  ...
  setVariantOption: (variantOption: number) => void;
}
              ...
              >
                ...
                <div className="flex items-center">
                  <button
                    ...
                    onClick={() => handleDecrement(product._id, product.variants[index]._id)}
                  >
                    -
                  </button>
                  <input
                  ...
                  <button
                    ...
                    onClick={() => handleIncrease(product._id, product.variants[index]._id)}
                  >
                    +
                  </button>
                </div>
                <div className="col-start-8 col-span-3 flex justify-center gap-3 items-center">
                  ...
                  <select
                    value={variantOption}
                    onChange={(e) => setVariantOption(Number(e.target.value))}
                ...
                <div className="col-start-11 flex justify-center">
                  <p>
                    {product.variants[variantOption]?.price?.toLocaleString(
                      "vi-VN",
                      {
                        style: "currency",
                        currency: "VND",
                ...
                <div className=" flex justify-end item-center text-lg font-semibold">
                  <p>
                    {(
                      product.variants[variantOption]?.price *
